...
| `code-quality-remediation.md` | DRY/SOLID remediation plan (2026-03-12 analysis) |
| `lint-remediation-plan.md` | Lint cleanup plan (Phase 8) |
| `e2e-testing-implementation-plan.md` | E2E testing expansion plan |
| `2026-04-06-ai-regression-testing.md` | AI regression test suite plan |
| `2026-04-08-security-review-ai-regression-tests.md` | Security review of the above (APPROVED) |
| `2026-03-01-fix-remaining-test-classes.md` | Flask→FastAPI test migration |
| `2026-03-01-fix-test-voice-design.md` | Voice-design test fixes |
| `2026-03-01-fix-test-voice-failures.md` | Voice test-failure fixes |
| `2026-03-04-review-fixes.md` | Post-merge code-review fixes (R-1–R-12) |
| `2026-03-21-fix-torch-env-test-failures.md` | Torch-env test fixes |
| `2026-03-25-gradio-allowed-paths-fix.md` | Gradio allowed-paths bugfix |
