<!-- Generated: 2026-09-18 | Files scanned: server/ (8.2k LOC), config/pm2.py (128 LOC) | Token estimate: ~870 -->
...
## Key files (LOC)
app_generation.py 1228 · app.py 1140 · app_lifespan.py 821 · websocket.py 654 · client/generator.py 620 · app_models.py 604 · app_prompts.py 561 · validation.py 539 (33 Pydantic models) · model_loading.py 541 · generation_state_guard.py 371 (new, 0C #270) · vllm_client.py 332 · prompt_loading.py 73
