...
246 tests across 57 classes. No GPU, models, or running server required. Tests auto-skip when optional deps (`soundfile`, `gradio`, `flask`) are missing — run in a conda env for full coverage.
